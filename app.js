...
(function () {
  ...
  const LYRIC_CUES = {
    ...
    2: {
      ...
      mute: 'MUTE right before “you belong…”',
      kids: 'Kids finish the chorus line',
      startAt: 53, muteAt: 61, unmuteAt: 108
    },
    3: {
      play: 'Play until the famous “bah bah bah”',
      mute: 'MUTE — hands ready',
      kids: 'Kids sing the bahs + “Sweet Caroline!”',
      startAt: 55, muteAt: 63, unmuteAt: 123
    },
    4: {
      play: 'Play the iconic guitar riff in',
      mute: 'MUTE before the title line',
      kids: 'Kids belt “Eye of the Tiger!”',
      startAt: 75, muteAt: 83, unmuteAt: 141
    },
    5: {
      play: 'Play into the big chorus',
      mute: 'MUTE before “don’t stop…”',
      kids: 'Kids finish “Don’t Stop Believin’!”',
      startAt: 195, muteAt: 203, unmuteAt: 250
    },
    6: {
      play: 'Play toward the “twenty-two” hook',
      mute: 'MUTE NOW',
      kids: 'Kids shout “22!” / finish the line',
      startAt: 34, muteAt: 42, unmuteAt: 68
    },
    7: {
      play: 'Play into the roar chorus',
      mute: 'MUTE before the roar',
      kids: 'Kids ROAR / finish the chorus',
      startAt: 37, muteAt: 45, unmuteAt: 70
    },
    8: {
      play: 'Play into “party in the USA”',
      mute: 'MUTE NOW',
      kids: 'Kids finish “Party in the USA!”',
      startAt: 36, muteAt: 44, unmuteAt: 72
    },
    9: {
      play: 'Play into “shake it off”',
      mute: 'MUTE before the title hook',
      kids: 'Kids shake + finish the line',
      startAt: 33, muteAt: 41, unmuteAt: 72
    }
  };
  ...
  function updateAutoSingCountdown(cue, t) {
    ...
    if (autoSingPhase === 'seeking') {
      ...
      cd.textContent = 'Chorus mute ' + formatMmSs(cue.muteAt) + '–' + formatMmSs(cue.unmuteAt) +
        ' · kids sing (' + left + 's)';
  ...
  function renderLyrics() {
    ...
    const timingHint = (cue.startAt != null)
      ? '<p class="cue-timing">Chorus mute ' + formatMmSs(cue.muteAt) + '–' + formatMmSs(cue.unmuteAt) +
        ' · seek ' + formatMmSs(cue.startAt) + '</p>'
      : '';
